class AllsController < ApplicationController
  ...
  private
    ...
    def all_params
      params.require(:all).permit(:one, :two, :three, :four, :five, :six, :seven, :listing_id, :nine, :ten, :eleven, :twelve, :thirteen, :fourteen, :fifteen, :sixteen, :seventeen, :eighteen, :nineteen)
    end
end
